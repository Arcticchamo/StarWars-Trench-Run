...
public class PlayerBulletSpawn : MonoBehaviour
{
    ...
    void Start()
    {
		m_BulletSpawn1 = transform.Find("BulletFirePoint1");
		m_BulletSpawn2 = transform.Find("BulletFirePoint2");
		m_BulletSpawn3 = transform.Find("BulletFirePoint3");
		m_BulletSpawn4 = transform.Find("BulletFirePoint4");
